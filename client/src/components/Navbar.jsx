...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center py-2 justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <button 
              className="bg-[#0071DC] hover:bg-[#0062BD] text-white px-4 py-2 rounded transition-colors"
            >
              Dashboard
            </button>
          </div>
      ...
      {/* Mobile Menu */}
      <div 
        className={`lg:hidden absolute top-16 left-0 w-full transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="bg-[#141414] border-t border-[#1F1F1F] shadow-lg rounded-b-lg">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-[#1F1F1F]">
            <div className="flex items-center">
              ...
              <span className="text-white font-medium">Server Status: {serverStatus}</span>
            </div>
